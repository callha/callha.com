  ...
  return (
    <div className="bg-[base-100] py-24 sm:py-32 ">
      <div className="mx-auto max-w-4xl   px-6 lg:px-8">
        ...
        <div className="text-xl font-semibold leading-7 text-info text-center py-12">        <Link role="button" className="btn btn-primary   hover:text-[#3f1de7] text-xl md:text-2xl font-bold rounded-full " href={'https://callhanet.feishu.cn/share/base/form/shrcnKgHyUU905ToaA3BzzW5ZM'}>{t('联系我们')} ↗</Link></div>
