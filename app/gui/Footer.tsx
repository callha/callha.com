            ...
            <div className="flex justify-center ">
                <footer className="footer  max-w-screen-xl p-6 lg:p-8  text-base-content">
                    ...
                    <nav>
                        ...
                        <Link href="/products/#教培" className="link link-hover">{t('教学培训')}</Link >
                        <Link href="/products/#咨询" className="link link-hover">{t('信息咨询')}</Link >
                        <Link href="/products/#开发" className="link link-hover">{t('开发软件')}</Link >
                        <Link href="/products/#电商" className="link link-hover">{t('抖音电商')}</Link >
                        <Link href="/products/#市场" className="link link-hover">{t('市场研究')}</Link >
                        <Link href="/products/#营销" className="link link-hover">{t('营销服务')}</Link >
                        <Link href="/products/#策划" className="link link-hover">{t('策划方案')}</Link >
                        <Link href="/products/#设计" className="link link-hover">{t('设计创意')}</Link >
                    </nav>
                    <nav>
                        <h6 className="footer-title">{t('关于')}</h6>
                        <Link href="https://callhanet.feishu.cn/share/base/form/shrcnKgHyUU905ToaA3BzzW5ZMd" className="link link-hover" target='_blank'>{t('联系我们')}↗</Link >
                        <Link href="https://callhanet.feishu.cn/docx/NOEUdkurRohsFGxscUQcMQAznSh?from=from_copylink" className="link link-hover" target='_blank'>{t('加入我们')}↗</Link >
                        <Link href="/blog" className="link link-hover">{t('博客动态')}</Link >
                        <Link href="/about" className="link link-hover">{t('关于我们')}</Link >
                    </nav>
                    <nav>
