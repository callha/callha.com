    ...
    <div className="py-12 ">
      <div className="mx-auto max-w-7xl lg:px-8  ">
        ...
        <div className=" md:grid grid-cols-2 gap-8 sm:flex-row flex-col px-4">
          ...
          <Cord src='/img/7开发.png' name='开发' text='DAPP、前端网站、EVM智能合约solidify、UI/UX设计、产品架构，区块链应用技术' />
          <Cord src='/img/8电商.jpg' name='电商' text='抖音电商，购买你喜欢的商品或服务' />
  ...
  return (
    <div id={name} className="card card-compact bg-base-100 shadow-xl border h-auto mt-4">
      ...
      <div className="card-body border-t">
        ...
        <p>{text}</p>
        <div className="card-actions justify-end">
          <Link href='https://callhanet.feishu.cn/share/base/form/shrcnKgHyUU905ToaA3BzzW5ZMd' className="btn btn-primary hover:text-secondary text-lg" target='_blank' >联系</Link>
        </div>
      </div>
    </div>
  )
